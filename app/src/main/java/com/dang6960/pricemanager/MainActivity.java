...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deviceMode = ResultsActivity.getDeviceMode(watchlistFrame);
                ...
                if(validateInputURL(searchText)) {
                    ...
                    try {
                        ...
                        if(!(c.moveToFirst()) || c.getCount() == 0){
                            ...
                            changeActivityIntent = new Intent(MainActivity.this, ResultsActivity.class);
                            bundle = new Bundle();
                            Gson gson = new Gson();
    ...
    public class ScrapeRequest extends AsyncTask<String, Integer, String>{
        ...
        /**
         * @see com.dang6960.pricemanager.ResultsActivity.ScrapeRequest
         * @param url item URL
         */
    ...
    public class SellerRequest extends AsyncTask<String, Integer, String> {
        ...
        /**
         * @see com.dang6960.pricemanager.ResultsActivity.SellerRequest
        ...
        protected String doInBackground(String... strings) {
            try {
                URL diffURL = new URL("https://api.diffbot.com/v3/article?token="+ ResultsActivity.DEVELOPER_TOKEN +"&url=" + listingsURL);
